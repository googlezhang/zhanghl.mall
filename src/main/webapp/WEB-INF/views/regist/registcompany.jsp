...
<div class="w" id="regist">
	<div class="mt">
		<h2>注册新用户</h2>
		<b></b>
        	<span style="text-align:right">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a onclick="javascript:location.href=&quot;http://passport.360buy.com/new2/global/switchlanguage.aspx?l=en&amp;ReturnUrl=http://passport.360buy.com/new2/registpersonal.aspx&quot;+location.search;" href="#">English</a></span>
		<span>我已经注册，现在就&nbsp;<a href="login.aspx" class="flk13">登录</a></span>
	</div>
	<div class="mc">
		<ul class="tab">
			<li><a href="registPersonal.aspx">个人用户</a></li>
		...
		<div id="superior">			
			<dl class="fore">
				<dt>360服务</dt>
				<dd>
			"<em>3</em>" 即30分钟内有指定专人为客户服务；<br />
			"<em>6</em>" 即全国60个重点城市6天内送货上门；<br />
			"<em>0</em>" 即全年0投诉，订单0积压。
				</dd>
			</dl>
			...
			<dl>
				<dt>申请条件</dt>
				<dd>
			必须是能提供合法的营业执照及法人代表身份证的单位或公司，单次消费金额在10000元（含）以上或年采购10万元以上客户。<br />如您对企业用户注册或批量购买有何疑问，<br/>可<a href="http://market.360buy.com/giftcard/company/default.aspx" target="_blank" class="flk13">点此向我们留言</a>。
				</dd>
			</dl>
		</div>
		...
		<div class="form">
			...
			<div class="item">
				...
				<div class="fl">
					...
					<label class="img">
                        <img style="cursor:pointer;width:100px;height:26px;" alt=""  onclick="this.src='JDVerification.aspx?a=0&amp;uid=0bcd3de9-3e40-45a4-9b64-3bf1ae75349f&amp;yys='+new Date().getTime()" ver_colorofnoisepoint="#888888" id="JD_Verification1" src="JDVerification.aspx?a=0&amp;uid=0bcd3de9-3e40-45a4-9b64-3bf1ae75349f"> </label>
			...
			<div class="item">
				<span class="label"><b class="ftx04">*</b>所在部门：</span>
				<div class="fl">
					<select rel="select" id="department" name="department" tabindex="6" >
			...
			<div class="item">
				...
				<div class="fl">
					<input type="text" id="tel" name="tel" class="text" tabindex="7"/>
			...
			<div class="item">
				...
				<div class="fl">
					<input type="text" id="mobile" name="mobile" class="text" tabindex="8"/>
			...
			<div class="item">
				...
				<div class="fl">
					<input type="text" id="mail" name="mail" class="text" tabindex="9"/>
			...
			<div class="item">
				...
				<div class="fl">
					<input type="text" id="companyname" name="companyname" class="text" tabindex="10"/>
			...
			<div class="item">
				...
				<div class="fl">
				    <span class="fl">
                    <select class="mar" name2="hncompanyarea" rel="select" tabindex="11" id="companyprovince" name="companyprovince" >
                            <option value="-1"  >请选择</option>
            ...
            <option value="84"  >钓鱼岛</option>
					...
					<span class="fl"><select class="mar" name2="hncompanyarea" rel="select" tabindex="11" id="companycity" name="companycity">
					<option value="-1" selected="selected">请选择</option>
					</select>
					</span>
					<span class="fl"><select id="companyarea" name="companyarea" name2="hncompanyarea" rel="select" tabindex="11">
					<option value="-1" selected="selected">请选择</option>
					</select>
					</span>
					...
					<span class="clr"></span>
					<label id="hncompanyarea_error"></label>
				</div>
			</div>
			<div class="item">
			...
			<div class="item">
				<span class="label"><b class="ftx04">*</b>购买类型/用途：</span>
				<div class="fl">                   <input id="purpose2" tabindex="13" class="checkbox" name="purposetype" runant="server" type="checkbox" value="1" />
      ...
      <label class="pad" for="purpose2">数码通讯</label>
          <input id="purpose2" tabindex="13" class="checkbox" name="purposetype" runant="server" type="checkbox" value="3" />
      <label class="pad" for="purpose3">办公用品耗材</label>
          <input id="purpose2" tabindex="13" class="checkbox" name="purposetype" runant="server" type="checkbox" value="4" />
      <label class="pad" for="purpose4">大家电</label>
          <input id="purpose2" tabindex="13" class="checkbox" name="purposetype" runant="server" type="checkbox" value="5" />
      <label class="pad" for="purpose5">项目合作-政府采购</label>
          <input id="purpose2" tabindex="13" class="checkbox" name="purposetype" runant="server" type="checkbox" value="6" />
      <label class="pad" for="purpose6">礼品</label>
			...
			<div class="item">
				...
				<div class="fl">
					<input type="text" id="companysite" name="companysite" class="text" tabindex="19"/>
			...
			<div class="item">
				...
				<div class="fl">
					<select rel="select" tabindex="20"  id="employees" name="employees">
					           <option value="-1"  >请选择</option>
            ...
            <option value="5"  >1000以上</option>
					...
					<label id="employee_succeed" class="blank"></label>
					<span class="clr"></span>
					<label id="employee_error"></label>
				</div>
			</div>
			<div class="item">
				<span class="label">公司行业：</span>
				<div class="fl">
					<select rel="select" tabindex="21" id="industry" name="industry" >
					           <option value="-1"  >请选择</option>
            ...
            <option value="46"  >其它</option>
					...
					<label id="industry_succeed" class="blank"></label>
					<span class="clr"></span>
					<label id="industry_error"></label>
				</div>
			</div>
			<div class="item">
				<span class="label">公司性质：</span>
				<div class="fl">
					<select rel="select" tabindex="22" id="nature" name="nature" >
					         <option value="-1"  >请选择</option>
            ...
            <option value="6"  >其他</option>
					...
					<label id="nature_succeed" class="blank"></label>
					<span class="clr"></span>
					<label id="nature_error"></label>
				</div>
			</div>
			<div class="item">
				<span class="label">&nbsp;</span>
				<input type="button" class="btn-img btn-regist" id="registsubmit" value="同意以下协议，提交" tabindex="23" />
		...
		<div id="protocol-con">
            <h4>
                                      ...
                                      <h5>
                                          第1条 本站服务条款的确认和接纳</h5>
                                      <p>
                                          <strong>1.1</strong>本站的各项电子服务的所有权和运作权归京东商城所有。用户同意所有注册协议条款并完成注册程序，才能成为本站的正式用户。用户确认：本协议条款是处理双方权利义务的契约，始终有效，法律另有强制性规定或双方另有特别约定的，依其规定。</p>
                                      <p>
                                      ...
                                      <h5>
                                          第3条 用户信息</h5>
                                      <p>
                                          <strong>3.1</strong>用户应自行诚信向本站提供注册资料，用户同意其提供的注册资料真实、准确、完整、合法有效，用户注册资料如有变动的，应及时更新其注册资料。如果用户提供的注册资料不合法、不真实、不准确、不详尽的，用户需承担因此引起的相应责任及后果，并且京东商城保留终止用户使用京东商城各项服务的权利。</p>
                                      <p>
                                          <strong>3.2</strong>用户在本站进行浏览、下单购物等活动时，涉及用户真实姓名/名称、通信地址、联系电话、电子邮箱等隐私信息的，本站将予以严格保密，除非得到用户的授权或法律另有规定，本站不会向外界披露用户隐私信息。</p>
                                      <p>
                                          <strong>3.3</strong>用户注册成功后，将产生用户名和密码等账户信息，您可以根据本站规定改变您的密码。用户应谨慎合理的保存、使用其用户名和密码。用户若发现任何非法使用用户账号或存在安全漏洞的情况，请立即通知本站并向公安机关报案。</p>
                                      <p>
                                      ...
                                      <p>
                                          <strong>3.6</strong><strong>用户同意，京东商城有权使用用户的注册信息、用户名、密码等信息，登陆进入用户的注册账户，进行证据保全，包括但限于公证、见证等。</strong></p>
                                      <h5>
                                          第4条 用户依法言行义务</h5>
                                      <p>
                                          本协议依据国家相关法律法规规章制定，用户同意严格遵守以下义务：</p>
                                      <p>
                                          <strong>（1）</strong>不得传输或发表：煽动抗拒、破坏宪法和法律、行政法规实施的言论，煽动颠覆国家政权，推翻社会主义制度的言论，煽动分裂国家、破坏国家统一的的言论，煽动民族仇恨、民族歧视、破坏民族团结的言论；</p>
                                      <p>
                                      ...
                                      <h5>
                                          第8条 所有权及知识产权条款</h5>
                                      <p>
                                          <strong>8.1</strong><strong>用户一旦接受本协议，即表明该用户主动将其在任何时间段在本站发表的任何形式的信息内容（包括但不限于客户评价、客户咨询、各类话题文章等信息内容）的财产性权利等任何可转让的权利，如著作权财产权（包括并不限于：复制权、发行权、出租权、展览权、表演权、放映权、广播权、信息网络传播权、摄制权、改编权、翻译权、汇编权以及应当由著作权人享有的其他可转让权利），全部独家且不可撤销地转让给京东商城所有，用户同意京东商城有权就任何主体侵权而单独提起诉讼。</strong></p>
                                      <p>
                                          <strong>8.2</strong><strong>本协议已经构成《中华人民共和国著作权法》第二十五条（条文序号依照2011年版著作权法确定）及相关法律规定的著作财产权等权利转让书面协议，其效力及于用户在京东商城网站上发布的任何受著作权法保护的作品内容，无论该等内容形成于本协议订立前还是本协议订立后。</strong></p>
                                      <p>
                                          <strong>8.3</strong><strong>用户同意并已充分了解本协议的条款，承诺不将已发表于本站的信息，以任何形式发布或授权其它主体以任何方式使用（包括但限于在各类网站、媒体上使用）。</strong></p>
                                      <p>
                                          <strong>8.4</strong><strong>京东商城是本站的制作者,拥有此网站内容及资源的著作权等合法权利,受国家法律保护,有权不时地对本协议及本站的内容进行修改，并在本站张贴，无须另行通知用户。在法律允许的最大限度范围内，京东商城对本协议及本站内容拥有解释权。</strong></p>
                                      <p>
                                          <strong>8.5</strong><strong>除法律另有强制性规定外，未经京东商城明确的特别书面许可,任何单位或个人不得以任何方式非法地全部或部分复制、转载、引用、链接、抓取或以其他方式使用本站的信息内容，否则，京东商城有权追究其法律责任。</strong></p>
                                      <p>
                                          <strong>8.6</strong>本站所刊登的资料信息（诸如文字、图表、标识、按钮图标、图像、声音文件片段、数字下载、数据编辑和软件），均是京东商城或其内容提供者的财产，受中国和国际版权法的保护。本站上所有内容的汇编是京东商城的排他财产，受中国和国际版权法的保护。本站上所有软件都是京东商城或其关联公司或其软件供应商的财产，受中国和国际版权法的保护。</p>
                                      <h5>
                                          第9条 责任限制及不承诺担保</h5>
                                      <p>
                                          <strong>除非另有明确的书面说明,本站及其所包含的或以其它方式通过本站提供给您的全部信息、内容、材料、产品（包括软件）和服务，均是在“按现状”和“按现有”的基础上提供的。</strong></p>
                                      <p>
                                          <strong>除非另有明确的书面说明,京东商城不对本站的运营及其包含在本网站上的信息、内容、材料、产品（包括软件）或服务作任何形式的、明示或默示的声明或担保（根据中华人民共和国法律另有规定的以外）。</strong></p>
                                      <p>
                                      ...
                                      <p>
                                          <strong>12.2</strong>京东商城尊重用户和消费者的合法权利，本协议及本网站上发布的各类规则、声明等其他内容，均是为了更好的、更加便利的为用户和消费者提供服务。本站欢迎用户和社会各界提出意见和建议，京东商城将虚心接受并适时修改本协议及本站上的各类规则。</p>
                                      <p>
