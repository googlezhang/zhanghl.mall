...
<div class="mt">
    ...
    <b></b><span style="text-align: right">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a
        ...
        href="#">English</a></span> <span>我已经注册，现在就&nbsp;<a href="login.aspx" class="flk13">登录</a></span>
</div>
<div class="mc">
<ul class="tab">
    ...
    <div class="form">
        ...
        <div id="o-password">
            <div class="item">
                ...
                <div class="fl">
                    <input type="password" id="pwd" name="pwd" class="text" tabindex="2" style="ime-mode:disabled;"/>
        ...
        <div class="item">
            ...
            <div class="fl">
                <input type="text" id="authcode" style="ime-mode:disabled" name="authcode" class="text text-1"
                       tabindex="6" autocomplete="off" MaxLength="6"/>
                <label class="img">
                    <img style="cursor:pointer;width:100px;height:26px;" alt=""
                         onclick="this.src='JDVerification.aspx?a=0&amp;uid=10894a3e-0cfb-431d-8854-a90bb865e891&amp;yys='+new Date().getTime()"
                         ver_colorofnoisepoint="#888888" id="JD_Verification1"
                         src="JDVerification.aspx?a=0&amp;uid=10894a3e-0cfb-431d-8854-a90bb865e891"> </label>
