...
<div class="mt">
    ...
    <span style="text-align:right">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a
            onclick="javascript:location.href=&quot;http://passport.360buy.com/new2/global/switchlanguage.aspx?l=en&amp;ReturnUrl=http://passport.360buy.com/new2/registpersonal.aspx&quot;+location.search;"
            href="#">English</a></span>
    <span>我已经注册，现在就&nbsp;<a href="login.aspx" class="flk13">登录</a></span>
</div>
<div class="mc">
<ul class="tab">
    <li class="line"><a href="registPersonal.aspx">个人用户</a></li>
    <li><a href="registCompany.aspx">企业用户</a></li>
    <li class="curr">校园用户</li>
</ul>

<div id="superior">
    <div class="fl"><img src="misc/skin/df/i/banner_school.jpg"/></div>
    <dl>
        <dt>申请成为校园用户</dt>
        <dd>
            ·注册校园用户并完成个人资料即可成为校园用户<br/>
            ·校园代理可享受送货上门服务，还可到自提点上门提货<br/>
            ·专享校园特供商品，发动全国性校园团购<br/>
            ·参与全国校园活动，参与推广与用户互动<br/>
            ·优秀校园代理有机会到京东商城就业<br/>
            &nbsp;&nbsp;<a href="http://www.360buy.com/help/member.aspx#rtop_01" class="flk13" target="_blank">了解更多关于校园用户</a>
        </dd>
    </dl>
</div>
...
<div class="form">
    ...
    <div class="item" id="select-school">
        <span class="label"><b class="ftx04">*</b>所在学校：</span>

        <div class="fl"> <!--class="pad"-->

            <div class="o-intelligent-school">
                <input type="text" class="text" id="schoolinput" tabindex="4"/>
                <ul id="intelligent-school" class="hide"></ul>
            </div>

            <input type="hidden" value="-1" id="hnschool"/><input type="hidden" id="schoolid" name="schoolid"/><input
                    type="hidden" id="hnseli"/>
            <label id="schoolinput_succeed" class="blank"></label>
            <span class="clr"></span>
            <label id="schoolinput_error"></label>
        </div>
    </div>
    <div class="item">
        ...
        <div class="fl">
            <input type="text" id="mail" name="mail" class="text" tabindex="6"/>
            <label id="mail_succeed" class="blank"></label>
            <label class="ftx23">免费邮箱：</label><a target="_blank"
    ...
    <div class="item">
        ...
        <div class="fl">
            <input type="text" id="referrer" name="referrer" class="text" value="可不填" tabindex="7"/>
    ...
    <div class="item">
        ...
        <div class="fl">
            <input type="text" id="authcode" style="ime-mode:disabled" name="authcode" class="text text-1"
                   tabindex="8"/>
            <label class="img">
                <img style="cursor:pointer;width:100px;height:26px;" alt=""
                     onclick="this.src='JDVerification.aspx?a=0&amp;uid=82520aad-0f7d-4d38-8de2-fb3c7dc33d66&amp;yys='+new Date().getTime()"
                     ver_colorofnoisepoint="#888888" id="JD_Verification1" src="JDVerification.aspx?a=0&amp;uid=82520aad-0f7d-4d38-8de2-fb3c7dc33d66">
            </label>
    ...
    <div class="item">
        ...
        <input type="button" class="btn-img btn-regist" id="registsubmit" value="同意以下协议，提交" tabindex="10"
               autocomplete="off"/>
    </div>
